...
print('File name : ', file_name + '_Method4.txt')
output_file = open(file_name + '_Method4.txt', 'w')
output_file.write('Multivariable Linear Regression (Method 4)\n')
output_file.write('Results of Boston House Price Data\n\n')
output_file.write('Averaged Stochastic process with constant step size and '
...
plt.savefig(file_name + '_Method4.png')
